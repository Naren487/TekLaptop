...
public class bookflight extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("pid", Util.getpassengerid(fid, firstname, lastname, gender, age, phone, email));
		flight pid=Util.getpassengerid(fid, firstname, lastname, gender, age, phone, email);
